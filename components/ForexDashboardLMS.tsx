...
//     }, 150);
//   };
//   // Tambahkan fungsi ini di dalam component ForexDashboardLMS, sebelum return statement: tambhakan fungsi
...
//         alert(
//           `File terlalu besar. Maksimal ${type === "video" ? "100MB" : "50MB"}`,
//         );
//         return;
//       }
...
//                     </p>
//                     <div className="mt-2">
//                       {/* Di dalam Lesson Modal, bagian upload file */}
//                       <Button
//                         variant="outline"
//                         size="sm"
//                         type="button"
...
//                               .files?.[0];
//                             if (file) {
//                               const type = registerLesson("type").value as
//                                 | "video"
//                                 | "pdf";
//                               await handleLessonFileUpload(file, type);
//                             }
//                           };
//                           input.click();
//                         }}
...
export default function ForexDashboardLMS() {
    ...
    return (
      <div>
        <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
          ...
          <Card>
            <CardContent>
              <h3 className="text-sm text-muted-foreground">Video Trading</h3>
                  ...
                  <div className="relative aspect-video bg-gray-900 rounded-t-lg overflow-hidden group">
                    ...
                    <div className="absolute inset-0 bg-black/50 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center">
                      <Button
                        ...
                        onClick={() => {
                          setSelectedVideo(video);
                          setActiveMenu("video-trading-preview"); // ✅ ROUTING BARU
                        }}
                      >
                        <Play className="mr-1 h-4 w-4" /> Tonton
                      </Button>
  ...
  // ✅ PANEL BARU: Video Trading Preview (terpisah dari VideoPanel untuk lesson)
  const VideoTradingPreviewPanel = () => {
    if (!selectedVideo) {
      return (
        <div className="py-12 text-center text-muted-foreground">
    ...
    return (
      <div>
        ...
        <Card>
          <CardContent className="p-0">
            {/* Video Player */}
            <div className="w-full bg-black aspect-video rounded-t-lg overflow-hidden">
              {selectedVideo.videoType === "YOUTUBE" ? (
                <iframe
  ...
  const VideoPanel = () => {
    // ✅ PERBAIKAN: Hanya untuk lesson video, bukan trading video
    const videoLesson =
      selectedLesson ||
      selectedCourse?.lessons?.find((l) => l.type === "video");
  ...
  // ✅ PANEL: Article View (untuk preview artikel)
  const ArticlePanel = () => {
    if (!selectedArticle) {
      return (
        <div className="py-12 text-center text-muted-foreground">
  ...
  const getPageTitle = () => {
    switch (activeMenu) {
      case "article-management":
        return "Manajemen Artikel";
      case "articles":
        return "Artikel";
      case "video-trading":
        return "Video Trading";
      case "video-trading-preview":
        return "Preview Video Trading";
      default:
        return activeMenu;
    }
  };
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-slate-900 text-slate-900 dark:text-slate-100">
      <Sidebar
        ...
        onLogout={handleLogout}
        onNavigate={(menu) => {
          // ✅ RESET SELECTED COURSE/ARTICLE/VIDEO SAAT PINDAH MENU
          if (
            menu !== "modules" &&
            menu !== "videos" &&
            menu !== "pdfs" &&
