            ...
            <div className="w-full md:w-[320px] bg-[#111827] p-5 sm:p-8 flex flex-col justify-between border-t md:border-t-0 md:border-l border-gray-800 relative z-10">
              ...
              <div>
                ...
                <div className="space-y-4">
                  ...
                  >
                    <div className="h-10 w-10 sm:h-12 sm:w-12 rounded-full bg-gradient-to-br from-[#00C9A7] to-blue-800 flex items-center justify-center flex-shrink-0 shadow-lg border-2 border-[#111827]">
                      <span className="text-white font-bold text-sm tracking-wider">SW</span>
                    </div>
                    <div>
