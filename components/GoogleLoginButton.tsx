...
export function GoogleLoginButton({ mode = "login" }: GoogleLoginButtonProps) {
  ...
  const handleGoogleAuth = () => {
    setIsLoading(true);
    // Redirect ke API route yang akan redirect ke Google
  ...
  return (
    <Button
      type="button"
      variant="outline"
      className="w-full relative flex items-center justify-center gap-3 h-11 border-gray-300 hover:bg-gray-50"
