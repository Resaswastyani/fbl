  ...
  return (
    ...
    >
      ...
      >
        ...
        <p className="text-gray-400 mb-6 max-w-md mx-auto">{t("lockedDesc")}</p>
        ...
        <p className="text-xs text-gray-500 mt-4">{t("clickButtonToFollow")}</p>
      </motion.div>
    </motion.div>
  );
};
        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20 lg:py-24">
          ...
          >
            ...
            <div className="flex flex-wrap justify-center gap-3 mt-8">
              <FeatureBadge
                icon={Timer}
                text={t("freeTrialSubtitle")
                  .replace("FREE TRIAL ", "")
                  .replace(" HARI", " Hari Full Access")}
              />
              <FeatureBadge icon={Award} text="Backtest Verified" />
              <FeatureBadge icon={Shield} text="Risk Management" />
              <FeatureBadge icon={BarChart3} text="Real-time Analytics" />
              ...
              <div className="relative bg-gradient-to-br from-[#111A4A] to-[#0a0f2e] rounded-3xl p-6 sm:p-8 border border-[#156d95]/30 shadow-2xl">
                ...
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-400">{t("eaSubtitle")}</p>
                    <div className="flex items-center gap-2 mt-1">
                      <span className="text-xs bg-green-500/20 text-green-400 px-2 py-0.5 rounded-full font-medium">
                        .ex5
                      </span>
                ...
                <AnimatePresence mode="wait">
                  {!isUnlocked ? (
                    ...
                    >
                      <div className="flex items-center gap-2 mb-3 text-green-400 text-sm">
                        <Unlock size={18} />
                        <span className="font-semibold">{t("unlocked")}</span>
                      </div>
                      <div className="flex flex-col sm:flex-row gap-3">
                        <GlowButton
                          onClick={handleDownload}
          ...
          >
            <h3 className="text-2xl sm:text-3xl font-bold text-white mb-3">
              {t("howToUse")}{" "}
              <span className="text-[#22d3ee]">{t("eaTrial")}</span>
            </h3>
            <p className="text-gray-400 text-sm sm:text-base">
              {t("stepsDesc")}
            </p>
