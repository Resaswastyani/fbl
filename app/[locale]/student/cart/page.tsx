    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-slate-900">
        <div className="text-center">
          ...
          <p className="mt-4 text-gray-600 dark:text-slate-300">{t("loadingCart")}</p>
        </div>
      </div>
    );
  }
        ...
        <div className="mb-8 flex items-start justify-between gap-4">
          <div>
            <Button
              variant="ghost"
              onClick={() => router.back()}
              className="mb-4 text-gray-600 dark:text-slate-300 hover:text-[#156d95]"
            >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2 space-y-6">
              {items.map((item) => (
                <Card
                  key={item.id}
                  className="border border-gray-200 dark:border-slate-700 hover:shadow-md transition-shadow"
                >
                    ...
                    <div className="flex flex-col md:flex-row md:items-center md:justify-between">
                      <div className="mb-4 md:mb-0 w-full md:w-auto">
                        ...
                        {item.isBundle && item.courseNames && (
                          <div className="mt-3 p-4 bg-gray-50 dark:bg-slate-800 rounded-lg">
                        ...
                        <div className="mt-4 flex items-center justify-between">
                          ...
                          <div>
                            <p className="text-sm text-gray-500 dark:text-slate-400">{t("subtotal")}</p>
            ...
            <div className="lg:col-span-1">
              ...
              <Card className="mt-6 border border-gray-200 dark:border-slate-700">
                <CardContent className="p-6">
                  <h3 className="font-bold text-lg mb-4 text-gray-900 dark:text-slate-100">{t("paymentInfo")}</h3>
