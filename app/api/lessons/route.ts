...
// GET /api/lessons - Get single lesson or list
...
export async function POST(req: NextRequest) {
  try {
    ...
    // Validate type
    const validTypes = ["video", "pdf", "text", "html"];
    ...
    // For HTML type, content is required (can contain images, text, etc)
    // For video/pdf type, contentUrl is required
