          ...
          >
            ...
            <motion.div variants={containerVariants} className="space-y-6">
              ...
              >
                ...
                <motion.span
                  className="font-bold text-[#111A4A] bg-gradient-to-r from-[#156d95]/10 to-transparent px-1 rounded"
                  whileHover={{
                    backgroundColor: "rgba(21, 109, 149, 0.2)",
                    scale: 1.02,
                  }}
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-sm text-[#374151] leading-relaxed">
                      ...
                      jawab penuh pengguna, termasuk risiko kerugian yang
                      mungkin timbul. Setiap transaksi yang Anda lakukan
                      sepenuhnya menjadi keputusan pribadi.
                    </p>
                  </div>
                </div>
              </motion.div>
